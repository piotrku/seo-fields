 ...
 */
class SeoFields extends Field
{
    use PerformsValidation, SupportsDependentFields;

    public $component = 'seo-fields';
    ...
    public function makeFullWidth()
    {
        ...
        //      ->fullWidth()->stacked()
        // from inline field creation when using the soe-field
        // but here only stacked() works and behaves as fullWidth()
    }
    ...
    {
        return view('seo.head-content')->render();
    }
}
