<template>
  <PanelItem :index="index" :field="field" class="seo-fields detail-field">
    <template #value>
      <div
        ...
        <table class="o1-table o1-w-full o1-table-default nova-resource-table">
          ...
          <tbody>
            <tr
              ...
              :key="i"
              class="seo-fields-table-row odd:o1-bg-slate-50 hover:o1-bg-slate-100 dark:odd:o1-bg-slate-700 dark:hover:o1-bg-slate-600"
            >
              <td
                class="o1-font-mono o1-text-sm seo-fields-detail-field-wrapper"
                style="height: 2rem"
...
<style lang="scss">
.seo-fields.detail-field {
  .seo-fields-detail-field-wrapper {
    > *,
